...
class MenuController:
    ...
    def startMenu():
        ...
        choice_input = [0, 1, 2]
        user_choice_input = Input.makeRightChoiceInput(
            choice_input, INPUT.MAIN_MENU)
        ...
        while user_choice_input != 0:
            if user_choice_input == 1:
                ...
                choice3_input = ["Y", "N"]
                user_choice3_input = Input.makeRightChoiceInput(
                    choice3_input,
                    INPUT.STR_IF_START_GAME,
                    False)
                ...
                user_choice4_input = Input.makeRightChoiceInput(
                    choice4_input, INPUT.MENU_REPORTS)
            ...
            choice5_input = ["Y", "N"]
            user_choice5_input = Input.makeRightChoiceInput(
                choice5_input,
                INPUT.STR_DISPLAY_REPORTS,
                False)
    ...
    def createTournament(date):
        ...
        numberOfRounds = Input.makeValideChoiceInput(
            INPUT.STR_TOURNAMENT_NUMBER_OF_ROUNDS, True)
